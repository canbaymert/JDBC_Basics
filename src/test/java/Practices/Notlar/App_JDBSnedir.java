...
2.Kname:POM AYARLARI ve PROJE UPDATE ETMEK
    <dependencies>
        <dependency>
    ...
    3.Kname) projenize gidin src deki sizin icin olusturulan paeti silin siz kendiniz
    istediginiz namede paket olusturun.Ornek:JdbcTurkceDersler
    Paketin altina main method secerek class olusturun. Ornek:JdbcQuery01

    4.Kname) SQL Structure nasil olacak?
    */
  ...
  6)  //table da 1.olusturulan sutun string se rs.getString(1), numbersa rs.getInt(1) 1--->sutunnosu
      ...
      //yada soyle yapabilirsin 
       //ornek: Select name, id, salary;
                       rs.getString("name"), rs.getString("id"),rs.getDouble("salary")
